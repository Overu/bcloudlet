...
public class Relationship {
   ...
   */
  public void setSource(ResourceBean source) {
    this.source = source;
  }
   ...
   */
  public void setTarget(ResourceBean target) {
    this.target = target;
  }
