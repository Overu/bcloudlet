...
import org.cloudlet.web.core.client.event.ActionEvent;
import org.cloudlet.web.core.client.event.ActionNames;
...
public class AppHistoryObserver implements HistoryObserver {
	...
	@Override
	//
	public HandlerRegistration bind(final EventBus eventBus,
	...
	@Override
	public void onAppStarted(final Place place,
			final HistoryHandler historyHandler) {
	}
