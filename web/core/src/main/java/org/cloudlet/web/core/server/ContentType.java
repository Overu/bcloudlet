...
public class ContentType implements UserType {
	...
	@Override
	public Object assemble(final Serializable cached, final Object arg1)
	...
	public Object nullSafeGet(final ResultSet resultSet, final String[] names,
		...
		String type = StringType.INSTANCE.nullSafeGet(resultSet, names[0],
				session);
		String id = StringType.INSTANCE.nullSafeGet(resultSet, names[1],
				session);
	...
	public void nullSafeSet(final PreparedStatement st, final Object value,
		...
		if (value == null) {
			...
			StringType.INSTANCE.nullSafeSet(st, content.getClass().getName(),
					index, session);
			StringType.INSTANCE.nullSafeSet(st, content.getId(), index + 1,
					session);
		}
	}

	@Override
	public Object replace(final Object original, final Object arg1,
			final Object arg2) throws HibernateException {
		return original;
	}
