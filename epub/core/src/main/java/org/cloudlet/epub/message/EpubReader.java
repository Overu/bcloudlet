...
import org.cloudlet.epub.datamodel.MediaType;
import org.cloudlet.epub.datamodel.Resource;
import org.cloudlet.epub.datamodel.Resources;
import org.cloudlet.epub.service.MediatypeService;
import org.cloudlet.epub.util.ResourceUtil;
...
public class EpubReader {
	 ...
	 *            a list of the MediaType to load lazily
	 * @return
	 * @throws IOException
	 */
	public Book readEpubLazy(String fileName, String encoding,
		...
		Resources resources = readLazyResources(fileName, encoding,
				lazyLoadedTypes);
	...
	public Book readEpubLazy(String fileName, String encoding)
			throws IOException {
		return readEpubLazy(fileName, encoding,
	...
	private Resources readLazyResources(String fileName,
			String defaultHtmlEncoding, List<MediaType> lazyLoadedTypes)
			throws IOException {
	...
	private Resources readResources(ZipInputStream in,
