...
public class Identifier implements Serializable {
	 ...
	 * 
	 * The Dublin Core metadata spec allows multiple identifiers for a Book. The
	 * epub spec requires exactly one identifier to be marked as the book id.
	 * 
	 * @return
	 */
	...
	public int hashCode() {
		return StringUtil.defaultIfNull(scheme).hashCode()
				^ StringUtil.defaultIfNull(value).hashCode();
	}
	...
	public boolean equals(Object otherIdentifier) {
		...
		return StringUtil.equals(scheme, ((Identifier) otherIdentifier).scheme)
				&& StringUtil.equals(value,
						((Identifier) otherIdentifier).value);
	}
