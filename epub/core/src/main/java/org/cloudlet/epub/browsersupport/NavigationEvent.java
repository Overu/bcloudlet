package org.cloudlet.epub.browsersupport;
...
/**
 * Used to tell NavigationEventListener just what kind of navigation action the
 * user just did.
 * 
 * @author paul
 * 
...
public class NavigationEvent extends EventObject {
	...
	public String toString() {
		return StringUtil.toString("oldSectionPos", oldSectionPos,
				"oldResource", oldResource, "oldBook", oldBook,
				"oldFragmentId", oldFragmentId, "oldSpinePos", oldSpinePos,
				"currentPagePos", getCurrentSectionPos(), "currentResource",
				getCurrentResource(), "currentBook", getCurrentBook(),
				"currentFragmentId", getCurrentFragmentId(), "currentSpinePos",
				getCurrentSpinePos());
	}
