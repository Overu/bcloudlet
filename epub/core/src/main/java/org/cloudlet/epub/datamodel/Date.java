...
import org.cloudlet.epub.message.PackageDocumentBase;
...
public class Date implements Serializable {
	...
	public enum Event {
		PUBLICATION("publication"), MODIFICATION("modification"), CREATION(
				"creation");
	...
	public Date(java.util.Date date, Event event) {
		this((new SimpleDateFormat(PackageDocumentBase.dateFormat))
				.format(date), event);
	}
