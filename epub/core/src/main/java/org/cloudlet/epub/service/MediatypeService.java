package org.cloudlet.epub.service;
...
public class MediatypeService {
	...
	public static final MediaType XHTML = new MediaType(
			"application/xhtml+xml", ".xhtml", new String[] { ".htm", ".html",
					".xhtml" });
	public static final MediaType EPUB = new MediaType("application/epub+zip",
			".epub");
	public static final MediaType NCX = new MediaType(
	...
	public static MediaType[] mediatypes = new MediaType[] { XHTML, EPUB, JPG,
			PNG, GIF, CSS, SVG, TTF, NCX, XPGT, OPENTYPE, WOFF, SMIL, PLS,
			JAVASCRIPT, MP3, MP4 };
	...
	/**
	 * Gets the MediaType based on the file extension. Null of no matching
	 * extension found.
	 * 
	 * @param filename
	 * @return
