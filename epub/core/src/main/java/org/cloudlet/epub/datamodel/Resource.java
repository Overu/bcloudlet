...
import org.cloudlet.epub.util.IOUtil;
import org.cloudlet.epub.util.StringUtil;
import org.cloudlet.epub.util.commons.io.XmlStreamReader;
...
public class Resource implements Serializable {
	 ...
	 * @param href
	 *            The resource's href within the epub.
	 */
	 ...
	 * 
	 * If this resource was lazy-loaded and the data was not yet loaded, it will
	 * be loaded into memory at this point. This included opening the zip file,
	 * so expect a first load to be slow.
	 * 
	 * @return The contents of the resource
	 */
