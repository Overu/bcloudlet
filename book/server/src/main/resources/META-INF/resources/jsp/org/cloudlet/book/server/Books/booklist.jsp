    ...
    <ul class="thumbnails">
      <c:forEach var="i" items="${it.items}" varStatus="status">
        ...
        <li class="span2 itm" book_id="${i.id}"><a href="${i.uri}" class="cover" hidefocus="hidefocus">
            <div class="thumbnail">
              <img src="${i.coverUrl}" alt="${i.summary}" ondragstart="return false;" oncontextmenu="return false;" onload="onLoadImg(this)"
                style="display: none" /> <a class="title" href="${ i.uri }" hidefocus="hidefocus">${ i.title }</a>
              <p class="author">
                <span>retech</span>
              </p>
