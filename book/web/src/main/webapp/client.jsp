...
<head>
<title>睿泰-客户端</title>
<jsp:include page="/jsp/org/cloudlet/core/server/meta.jsp"></jsp:include>
...
<body>
  <div id="wrap">
    <jsp:include page="/jsp/org/cloudlet/core/server/header.jsp"></jsp:include>
    <div id="brand">
      <div class="slide"
    ...
    <jsp:include page="/jsp/org/cloudlet/core/server/footer.jsp"></jsp:include>
  </div>
  <script>
